...
/** Fixed "today", well past the fixtures, so every week below counts as settled. */
...
describe("computeAnalytics", () => {
  it("summarizes weight journey, averages, and weekly rows", () => {
    ...
    const a = computeAnalytics([...week1, ...week2], goals, TODAY);
  ...
  it("handles an empty / weightless history without crashing", () => {
    const a = computeAnalytics([], goals, TODAY);
